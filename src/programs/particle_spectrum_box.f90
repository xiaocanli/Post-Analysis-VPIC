!*******************************************************************************
! Main program to calculate particle spectrum in a user defined box.
!*******************************************************************************
program particle_spectrum_box
    use mpi_module
    ...
    call calc_energy_spectra(tframe, 'e')
    call set_energy_spectra_zero

    call calc_energy_spectra(tframe, 'h')
...
end program particle_spectrum_box
