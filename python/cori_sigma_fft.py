...
def magnetic_power_spectrum(plot_config, show_plot=True):
    ...
    ax.set_prop_cycle('color', COLORS)
    tframes = range(20, 51, 10)

    for tframe in tframes:
        tindex = tframe * pic_info.eparticle_interval
    ...
    ax1.plot(tenergy, ene_magnetic, linewidth=1, color='k')
    ...
    ax1.scatter(tframes, [0.8]*nframe, c=COLORS[:nframe],
