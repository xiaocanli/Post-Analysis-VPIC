...
def plot_spectrum(plot_config):
    ...
    for tframe in range(tstart, tend + 1):
        ...
        ax.loglog(ebins_mid, spect[3:], linewidth=1,
...
def get_cmd_args():
    ...
    """
    default_pic_run = '2D-Lx1000-bg0.0-400ppc-1024KNL'
    ...
    parser.add_argument('--tstart', action="store", default='1', type=int,
                        help='starting time frame')
    parser.add_argument('--tend', action="store", default='474', type=int,
