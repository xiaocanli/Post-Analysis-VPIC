...
IF(${BASEDIR} MATCHES "build*")
    SET(TOPDIR "${CMAKE_SOURCE_DIR}/..")
ELSE()
    SET(TOPDIR "${CMAKE_SOURCE_DIR}")
ENDIF()

LIST(REMOVE_ITEM TOPDIR ".git")
...
# This assumes that we are in build* directory
FILE(GLOB_RECURSE CMAKECACHE "${BASEDIR}/*CMakeCache.txt")
FILE(GLOB_RECURSE CMAKEINSTALL "${BASEDIR}/*cmake_install.cmake"
                               "${BASEDIR}/*install_manifest.txt")
FILE(GLOB_RECURSE MAKEFILE "${BASEDIR}/*Makefile")
FILE(GLOB_RECURSE CMAKETESTFILES "${BASEDIR}/*CTestTestfile.cmake")
FILE(GLOB EXECUTABLES "${TOPDIR}/*exec")
