...
#DW stage_out source=$DW_PERSISTENT_STRIPED_reconnection/input/data_post destination=/global/cscratch1/sd/xiaocan/3D-Lx150-bg0.2-150ppc-2048KNL/data_post type=directory
